...
```text
我要开发一个 npm CLI 工具，项目名 relay-kit，命令名 relay。

定位：
Skills-first、CLI-assisted 的 AI 编程 Relay Strategy 工具包。
...
5. 创建 .relay/config.json 和 state.json
6. 创建 docs/agent-handoffs/runs
7. 创建 AGENTS.md 或注入 relay-kit 区块
8. 导出 skills/relay-* 到 .relay/skills
